...
const logoutButton = document.getElementById('logout-button').style.display="none";


/*===== LOGIN HIDDEN AND REGISTER APPEARS=====*/
function showRegisterForm() {
    document.getElementById("login-content").style.display = "none";
    document.getElementById("register-content").style.display = "grid";
}

/* =========REGISTER HIDDEN AND LOGIN APPEARS========= */
function showLoginForm() {
    document.getElementById("register-content").style.display = "none";
    document.getElementById("login-content").style.display = "grid";
}
...
sr.reveal('.home__data, .featured__container, .join__data, .testimonial__container,.footer')
